...
export const metadata: Metadata = {
  ...
  title: {
    default: "المحترف | أفضل شركة قص وتخريم خرسانة بجدة ومكة والطائف",
    template: "%s | المحترف لقص وتخريم الخرسانة بجدة ومكة والطائف",
  },

  // ======= META DESCRIPTION JAZAB =======
  description:
    "المحترف لقص وتخريم الخرسانة بجدة ومكة والطائف – عروض وخصومات حصرية الآن! تنفيذ سريع، أسعار منافسة، خدمة 24 ساعة. اتصل واحصل على أفضل النتائج!",
