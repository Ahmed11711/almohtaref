...
export default function BlogDetail({ blog }: BlogDetailProps) {
    ...
    useEffect(() => {
        setMounted(true);
        // Ensure scroll to top on mobile when navigating
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <article className="min-h-screen bg-black text-white pt-28 md:pt-36 pb-20 overflow-x-hidden w-full relative">
            {/* Hero Banner */}
            <div className="relative w-full h-[35vh] md:h-[60vh] max-h-[600px] mb-8 md:mb-12">
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center">
                    <div className="container mx-auto px-4 text-center max-w-4xl">
                        ...
                        <h1
                            className="text-2xl md:text-5xl lg:text-3xl font-bold mb-4 md:mb-6 leading-tight break-words px-2"
                            suppressHydrationWarning
                        >
                            {displayTitle}
                        </h1>
                        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-6 text-gray-300 text-[10px] sm:text-xs md:text-base">
            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="mb-6 md:mb-10">
                    <Link
                        href="/blog"
                        className="inline-flex items-center text-yellow-500 hover:text-yellow-400 transition-colors p-2 -ml-2 text-sm md:text-base"
                    >
                        <span className={`text-lg md:text-xl ${language === 'ar' ? 'ml-2' : 'mr-2'}`}>
                            {language === 'ar' ? '←' : '←'}
                        </span>
                ...
                {/* Content */}
                <div
                    className="bg-zinc-900 md:bg-zinc-900/50 md:backdrop-blur rounded-2xl p-5 md:p-12 border border-zinc-800 w-full overflow-hidden"
                    dir={language === 'ar' ? 'rtl' : 'ltr'}
                >
                    <div
                        className="text-base md:text-2xl font-light text-gray-300 mb-8 md:mb-10 leading-relaxed border-l-4 border-yellow-500 pl-4 md:pl-6 italic break-words"
                        suppressHydrationWarning
                    ...
                    {mounted ? (
                        <div
                            className="blog-content prose prose-invert prose-sm sm:prose-base md:prose-lg max-w-none w-full break-words
